    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            "z-50 inline-flex w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5 rounded-md border px-3 py-1.5 text-xs shadow-lg",
        ...
        >
          ...
          <TooltipPrimitive.Arrow
            className={cn(
              ...
              isDark ? "bg-zinc-900 fill-zinc-900" : "bg-white fill-white",
